...
namespace PokemonReviewApp.Migrations
{
    ...
    [Migration("20250627181311_FixErrorINIsActiveColumn")]
    partial class FixErrorINIsActiveColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PokemonReviewApp.Models.RefreshToken", b =>
                {
                    ...
                    b.Property<bool>("IsActive")
                        ...
                        .HasColumnType("bit")
                        .HasComputedColumnSql("Case When [IsUsed] = 0 And [IsRevoked] = 0 And [Expires] > GETUTCDATE() THEN 1 ELSE 0 END", false);
            ...
            modelBuilder.Entity("PokemonReviewApp.Models.RefreshToken", b =>
                {
                    b.HasOne("PokemonReviewApp.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
